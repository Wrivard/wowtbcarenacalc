...
import { PROFESSIONS, getProfession, type ProfTier, type ProfCost } from "@/data/professions";
...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  return buildMetadata({
    title: `${p.name} in TBC Classic — Benefits, Best Classes & Leveling`,
    description: `Is ${p.name} worth it in TBC Classic? What it provides for PvP and PvE, which classes benefit most, cost to level, and a 1–375 summary.`,
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-[720px] px-4 pt-8">
        ...
        <section className="mt-8" aria-label="Leveling summary">
          <h2 className="text-xl font-semibold tracking-tight">Leveling 1–375</h2>
          <p className="mt-3 text-sm leading-relaxed text-muted-strong">
            {p.levelingSummary}
          </p>
          <p className="mt-2 text-xs text-muted">
            This is a summary, not a full route — pair it with an up-to-date
            leveling guide for exact recipe counts.
          </p>
        </section>
